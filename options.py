...
def get_options():
	...
	parser.add_argument("--p_grad", help='prescribed gradient in x direction [Pa/m]', type=float, default=-1000)
	...
	parser.add_argument("--Ks", help='Sandgrain roughness [m]', type=float, default=1e-9)
	...
	parser.add_argument("--tracktime", help='length of time to track particle for', type=float, default=1)
	parser.add_argument("--D", help='particle diameter as fraction of L [-]', type=float, default=6.7e-4)
	parser.add_argument("--M", help='Particle mass', type=float, default=3e-10)
