...
def get_options():
	...
	parser.add_argument("--dt", help='dt in particle tracking', type=float, default=0.01)
	parser.add_argument("--tracktime", help='length of time to track particle for', type=float, default=0.2)
	parser.add_argument("--D", help='particle diameter as fraction of L [-]', type=float, default=0.05)
	parser.add_argument("--M", help='Particle mass', type=float, default=10e-6)
