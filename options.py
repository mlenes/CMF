...
def get_options():
	...
	parser.add_argument("--p_grad", help='prescribed gradient in x direction [Pa/m]', type=float, default=-20)
	parser.add_argument("--rho_ref", help='reference density [kg/m3]', type=float, default=1060)
	parser.add_argument("--N", help='Amount of grid points', type=int, default=2000)
	parser.add_argument("--mu", help='Molecular viscosity [Pas]', type=float, default=0.003)
	parser.add_argument("--Ks", help='Sandgrain roughness [m]', type=float, default=1e-3)
	...
	parser.add_argument("--dt", help='dt in particle tracking', type=float, default=0.001)
	parser.add_argument("--tracktime", help='length of time to track particle for', type=float, default=10)
	parser.add_argument("--D", help='particle diameter [m]', type=float, default=1e-3)
	parser.add_argument("--rho_p", help='Particle density [kg/m3]', type=float, default=1060)
