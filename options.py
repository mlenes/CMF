...
def get_options():
	...
	parser.add_argument("--p_grad", help='prescribed gradient in x direction', type=float, default=-0.1)
	...
	parser.add_argument("--wallgradient", help='gradient of velocity at the wall', type=float, default=-4)
