...
def get_options():
    ...
    parser.add_argument("--p_grad", help='prescribed gradient in x direction [-]', type=float, default=-200)
    parser.add_argument("--N", help='Amount of grid points', type=int, default=100)
    parser.add_argument("--mu", help='Molecular viscosity compared to water [-]', type=float, default=1)
    parser.add_argument("--global_type", help='Type of global boundary condition', type=str, default='p_grad')
    parser.add_argument("--flowrate", help='Flow rate global boundary condition [-]', type=float, default=20)
    parser.add_argument("--L", help="Width of the channel compared to L_ref [-]", type=float, default=1)
