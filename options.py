...
def get_options():
    ...
    parser.add_argument("--mu", help='Molecular viscosity', type=float, default=1)
    parser.add_argument("--global_type", help='Type of global boundary condition', type=str, default='p_grad')
    parser.add_argument("--flowrate", help='Flow rate global boundary condition', type=float, default=30)
